...
function bidding_intell(cards, current_player, history_of_bids){
    ...
    latest_three_bids = history_of_bids.slice(Math.max(history_of_bids.length -3, 0))
    ...
    console.log(trumps_available)
    console.log(bid_goal_arr_index)
    console.log(bid_goal)
    console.log(bid_goal_arr)
    console.log(latest_bid)
    console.log(possible_bids_left)
...
console.log(bidding_intell(cards, current_player, bidArray))
