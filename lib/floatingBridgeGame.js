...
bidderCI = {'lower':winnerHistory.bidder/simulationRounds - 1.96*Math.sqrt(winnerHistory.bidder/simulationRounds*(1-winnerHistory.bidder/simulationRounds)/simulationRounds),'upper':winnerHistory.bidder/simulationRounds + 1.96*Math.sqrt(winnerHistory.bidder/simulationRounds*(1-winnerHistory.bidder/simulationRounds)/simulationRounds)}
opponentCI = {'lower':winnerHistory.opponent/simulationRounds + 1.96*Math.sqrt(winnerHistory.opponent/simulationRounds*(1-winnerHistory.opponent/simulationRounds)/simulationRounds),'upper':winnerHistory.opponent/simulationRounds + 1.96*Math.sqrt(winnerHistory.opponent/simulationRounds*(1-winnerHistory.opponent/simulationRounds)/simulationRounds)}
    ...
    surface.select('.winningBoard').append('text')
        ...
        .attr('fill','white')
        .attr('font-weight',"bold")
        .text(function(d) {return 'Bidder Winning Chance: ' + winnerHistory.bidder/simulationRounds;});
    surface.select('.winningBoard').append('text')
        .attr('class','player' + i + 'score')
        .attr("x",function(d){return (maxCols*0.41)*cellWidth+"px";})
    ...
    surface.select('.winningBoard').append('text')
        ...
        .attr('fill','white')
        .attr('font-weight',"bold")
        .text(function(d) {return 'Bidder % Winning CI: ' + Math.floor(bidderCI.lower*1000)/1000 + ' to ' + Math.floor(bidderCI.upper*1000)/1000});
    surface.select('.winningBoard').append('text')
        .attr('class','player' + i + 'score')
        .attr("x",function(d){return (maxCols*0.41)*cellWidth+"px";})
